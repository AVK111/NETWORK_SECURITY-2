...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipleineConfig):
...
class DataValidConfig:
    def __init__(self,training_pipeline_config:TrainingPipleineConfig):
        ...
        # file paths for validated/invalid train and test files
